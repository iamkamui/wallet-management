...
class TestCheckBalanceEndpoint(APITestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.endpoint = reverse("transaction:wallet-check-balance")

    def test_check_balance_unauthenticated_user_returns_401(self):
        payload = {"wallet": self.wallet.number}
    ...
    def test_check_balance_authenticated_non_owner_returns_403(self):
        ...
        payload = {"wallet": self.wallet2.number}
        response = self.client.get(self.endpoint, payload, format="json")
    ...
    def test_check_balance_authenticated_owner_returns_200(self):
        ...
        expected_response = {"wallet": self.wallet2.pk, "balance": "150.00"}
